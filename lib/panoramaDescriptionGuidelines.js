...
- If the neighbourhood is known, use the neighbourhood instead of the wider city.
- Name the single strongest USP only.

DESCRIPTION:
- Full editorial property description.
- The English description must be 480–500 words.
- Spanish, French, Dutch and German descriptions must be similarly substantial.
- Never return a short summary.
- The description must contain exactly 5 paragraphs.
- Each paragraph must be separated by a newline.
- Flowing sophisticated prose, never bullets.
- Present tense.
- No price.
- No bedroom count.
- No m² unless the figure is genuinely exceptional and worth highlighting.
- Use aspirational but precise real estate language.
- Use em dashes — not hyphens.
- Avoid generic wording.
- If the source data is limited, expand using only confirmed lifestyle implications, location benefits and spatial flow. Do not invent unconfirmed features.
